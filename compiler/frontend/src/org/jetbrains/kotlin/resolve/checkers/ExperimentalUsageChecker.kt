...
class ExperimentalUsageChecker(project: Project) : CallChecker {
    ...
    companion object {
        ...
        private fun checkExperimental(
            ...
            val experimentalities = descriptor.loadExperimentalities(moduleAnnotationsResolver).filterNot { experimentality ->
                element.isExperimentalityAccepted(experimentality.annotationFqName, context)
            }
         ...
         */
        private fun PsiElement.isExperimentalityAccepted(
